...
ImageGO2D::ImageGO2D(string _fileName, ID3D11Device* _GD, PASS _pass) :m_pTextureRV(nullptr)
{
	string fullfilename =
#if DEBUG
		"../Debug/"
...
ImageGO2D::ImageGO2D(ID3D11ShaderResourceView * _pTextureRV, PASS _pass)
{
	m_pTextureRV = _pTextureRV;
	m_pass = _pass;
}
